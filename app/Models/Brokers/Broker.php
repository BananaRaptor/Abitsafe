...
abstract class Broker extends DatabaseBroker
{
    public function __construct(?Database $database = null)
    {
        ...
        $this->addSessionVariable('abitsafe.encryption_key', ENCRYPTION_KEY);
        if (!is_null(Session::getInstance()->read('UserCryptKey'))) {
            $this->addSessionVariable('abitsafe.authentication_key', Session::getInstance()->read('UserCryptKey'));
        }
    }
