...
abstract class SecurityController extends ZephyrusBaseController
{
    ...
    private function setupAuthorizations()
    {
        ...
        parent::getAuthorization()->addSessionRule('connected', 'id');
        /**
        ...
        parent::getAuthorization()->protect('/index', Authorization::ALL,'connected');
        parent::getAuthorization()->protect('/password', Authorization::ALL,'connected');
        parent::getAuthorization()->protect('/fullPassword', Authorization::ALL,'connected');
        parent::getAuthorization()->protect('/removePassword', Authorization::ALL,'connected');
        parent::getAuthorization()->protect('/favoritePassword', Authorization::ALL,'connected');
        parent::getAuthorization()->protect('/sharePassword', Authorization::ALL,'connected');
        parent::getAuthorization()->protect('/addPassword', Authorization::ALL,'connected');
        parent::getAuthorization()->protect('/creditcard', Authorization::ALL,'connected');
        parent::getAuthorization()->protect('/share', Authorization::ALL,'connected');
         ...
         */
        parent::getAuthorization()->protect('/createUser', Authorization::ALL, 'public');
